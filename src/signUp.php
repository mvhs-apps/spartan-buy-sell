    ...
    <main class="mdl-content">
        <?php 
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (empty($_POST["username"])) {
                    $userErr = "You must enter a username";
                } else {
                    $username = testMethod($_POST["username"]);
                }
            }
        ...
        <form action = "<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" id="user" pattern="[A-Z,a-z, ]*" name="username">
                <label class="mdl-textfield__label" id="user">User Name</label>
                <span class="mdl-textfield__error">Letters and Spaces Only</span>
            </div><br>
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" id="email" pattern="[FILTER_VALIDATE_EMAIL*]" name="username">
